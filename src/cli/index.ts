...
import { getSessionManager, type SessionInfo } from "../session/index.js";
import { runBootstrap, type SyncResult } from "../bootstrap/index.js";
...
async function listSessions(manager: ReturnType<typeof getSessionManager>): Promise<void> {
...
async function showConfig(manager: ReturnType<typeof getSessionManager>): Promise<void> {
...
async function launchPi(sessionId: string, manager: ReturnType<typeof getSessionManager>): Promise<void> {
...
function findPiExecutable(): { cmd: string; args: string[] } {
